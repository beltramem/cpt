...
public class Mesure implements Serializable {
    ...
    public Mesure(int id, String identifiant_utilisateur, Date date, float vitesse, float distance_parcourue, int calories_brulees, float puissance_developpe, int rythme_cardiaque) {
        this.id = id;
        this.identifiant_utilisateur = identifiant_utilisateur;
        this.date = date;
        this.vitesse = vitesse;
